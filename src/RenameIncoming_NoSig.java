...
public class RenameIncoming_NoSig implements CCNInterestHandler, CCNContentHandler {
	...
	public RenameIncoming_NoSig(ContentName tName) throws ConfigurationException, IOException {
	...
	private ContentObject renameCO(ContentObject incCO) throws InvalidKeyException, SignatureException, ContentEncodingException, ContentDecodingException
	{
		//System.out.println("Received original ContentObject: "+incCO.name());
		
		ContentName cn  = incCO.name();
		cn.decode( _name.append(cn).encode() );
